...
 SendPick Driver Mobile App - Dokumentasi API

Base URL: `https://isslab.web.id/api/driver`
...
## "pickup_lng": 107.1725,
## "delivery_lat": -6.9147,
## "delivery_lng": 107.6098,
## "pickup_phone": "08123456789",
## "recipient_phone": "08577654321",
"delivery_address": "Jl. Gatot Subroto No. 25, Jakarta",
...
## {
"success": false,
"message": "Job order tidak
ditemukan atau sudah tidak tersedia"
## }
## 422
## {
"success": false,
"message": "Anda sudah memiliki 5
order aktif. Selesaikan order
terlebih dahulu."
## }
...
## Longitude (-180 -
## 180)
locations[].sent_at datetime
## ✅
Waktu pengambilan
## GPS
locations[].order_id string
## ❌
...
## 1⃣4⃣ Check Vehicle Availbality
...
## Parameter Type Deskripsi
VehicleId string ID Kendaraan yg ingin
dicek
...
Update FCM Token
Menyimpan token Firebase Cloud Messaging buat push notification.
## Request:
...
## Status Deskripsi
## Pending
Order baru dibuat, belum ada driver
## Assigned
...
## Nearby
Sudah dekat/sampai di lokasi tujuan
## Delivered
Pengiriman selesai
## Cancelled
Order dibatalkan
...
- Token Storage: Simpan token di secure storage (Keychain iOS /
EncryptedSharedPreferences Android)
- GPS Tracking: Kirim data GPS dalam batch setiap 30 detik untuk
menghemat bandwidth
- Offline Mode: Simpan data GPS secara lokal dan sync saat online
- Image Compression: Kompres foto POD sebelum upload (max 1MB
recommended)
